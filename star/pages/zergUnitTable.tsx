...
export default function zergUnitTable() {
	return (
		<div>
			<Header />
			<Table />
...
const Header = () => {
	return <div><h1><a href='https://db-final-nextapi-aikcx.run.goorm.io'>StarCraft Zerg Units</a></h1><h2>20171017 전지용</h2></div> 
}
...
const Table = () => {
	...
	const fetchUnit = async () => {
		try {
			const res = await axios.get('https://db-final-nextapi-aikcx.run.goorm.io/api/zergUnit')
			setUnits(res.data)
		} catch (err) {
			console.log(err)
		}
